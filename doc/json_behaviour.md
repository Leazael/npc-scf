...
Some further cleanup of the substrings (such as the removal of the "!" and other punctuation markls) is performed using the rules specified in "Mappings" object below.
